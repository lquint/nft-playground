...
const Test = function test() {
  return (
    <>
      ...
      <div
        id="nftDisplay"
        className="container flex flex-row flex-wrap justify-center h-full mx-auto overflow-y-auto bg-sky-900 gap-x-10 gap-y-10"
      >
        <div className="flex flex-col transition ease-in-out delay-150 border border-black rounded-3xl bg-slate-900 basis-1/4 h-2/5">
          ...
          <div className="flex flex-row justify-start px-6 pt-3 pb-1 flex-nowrap">
            <div className="inline-block px-3 py-1 mb-2 mr-2 text-xs font-semibold text-gray-700 bg-gray-100 rounded-full">
              ID : 23
            </div>
            <div className="inline-block px-3 py-1 mb-2 mr-2 text-xs font-semibold text-gray-700 bg-gray-400 rounded-full">
              ERC-721 Token
            </div>
          </div>
